...
draw(PDF(figz * "/fig-kappa-a.pdf",12cm,10cm),f3a)
...
CSV.write(data*"/critical-kappa.csv",C)
...
f3b = plot(
    ...
    Scale.x_log10,
    Guide.xlabel("Critical value, κ*"),
    Guide.ylabel("Mortality ratio, ε"),
...
draw(PDF(figz * "/fig-kappa-b.pdf",13cm,10cm),f3b)
...
draw(PDF(figz * "/fig-kappa-c.pdf",13cm,10cm),f3c)
